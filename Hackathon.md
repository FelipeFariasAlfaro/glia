...
4.  **Razonamiento (Gemini 3.1 Flash Lite):** Gemini recibe el código nuevo + el contexto histórico rescatado por GLIA. Razona si el cambio actual repite un error del pasado.
...
*   **De Script Local a Cloud-Native:** Migramos un motor que funcionaba por `stdio` a una arquitectura de microservicios protegida por **Service Agent Tokens** de Google.
*   **Gestión de Modelos:** Superamos la obsolescencia de versiones previas integrando **Gemini 3.1 Flash Lite Preview**, optimizando la latencia de respuesta.
